...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuSystemD = QtWidgets.QMenu(self.menuOptions)
        self.menuSystemD.setObjectName("menuSystemD")
        ...
        self.actionEnable_create_snapshot_on_boot = QtWidgets.QAction(MainWindow)
        self.actionEnable_create_snapshot_on_boot.setCheckable(True)
        self.actionEnable_create_snapshot_on_boot.setEnabled(False)
        self.actionEnable_create_snapshot_on_boot.setObjectName("actionEnable_create_snapshot_on_boot")
        self.actionEnable_auto_Timeline_cleanup = QtWidgets.QAction(MainWindow)
        self.actionEnable_auto_Timeline_cleanup.setCheckable(True)
        self.actionEnable_auto_Timeline_cleanup.setEnabled(False)
        self.actionEnable_auto_Timeline_cleanup.setObjectName("actionEnable_auto_Timeline_cleanup")
        self.actionEnable_auto_daily_cleanup = QtWidgets.QAction(MainWindow)
        self.actionEnable_auto_daily_cleanup.setCheckable(True)
        self.actionEnable_auto_daily_cleanup.setEnabled(False)
        self.actionEnable_auto_daily_cleanup.setObjectName("actionEnable_auto_daily_cleanup")
        ...
        self.menuSystemD.addAction(self.actionEnable_create_snapshot_on_boot)
        self.menuSystemD.addAction(self.actionEnable_auto_Timeline_cleanup)
        self.menuSystemD.addAction(self.actionEnable_auto_daily_cleanup)
        ...
        self.menuOptions.addAction(self.menuSystemD.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuSystemD.setTitle(_translate("MainWindow", "SystemD"))
        ...
        self.actionEnable_create_snapshot_on_boot.setText(_translate("MainWindow", "Enable create snapshot on boot"))
        self.actionEnable_auto_Timeline_cleanup.setText(_translate("MainWindow", "Enable auto Timeline cleanup"))
        self.actionEnable_auto_daily_cleanup.setText(_translate("MainWindow", "Enable auto daily cleanup"))
